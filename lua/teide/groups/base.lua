...
function M.get(c, opts)
  -- stylua: ignore
  return {
    Foo                         = { bg = c.yellow1, fg = c.fg }, --magenta2
    ...
    Folded                      = { fg = c.blue, bg = Util.blend_bg(c.bg_highlight, 0.7) }, -- line used for closed folds
    ...
    CursorLineNr                = { fg = c.orange1, bold = true }, -- Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
    LineNrAbove                 = { fg = c.fg_gutter },
    LineNrBelow                 = { fg = c.fg_gutter },
    MatchParen                  = { fg = c.orange1, bold = true }, -- The character under the cursor or just before it, if it is a paired bracket, and its match. |pi_paren.txt|
    ...
    FloatBorder                 = { fg = c.fg_gutter, bg = c.bg_float },
    ...
    Number                      = { fg = c.green }, --  a number constant: 1, 2, 3
    ...
    Keyword                     = { fg = c.magenta2, style = opts.styles.keywords }, --  any other keyword
    ...
    LspInlayHint                = { bg = Util.blend_bg(c.teal, 0.1), fg = c.dark3 },
