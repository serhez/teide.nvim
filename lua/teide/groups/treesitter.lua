...
function M.get(c, opts)
  ...
  local ret = {
    ...
    ["@keyword"]                    = { fg = c.red, style = opts.styles.keywords }, -- For keywords that don't fall in previous categories.
    ...
    ["@keyword.function"]           = { fg = c.red, style = opts.styles.functions }, -- For keywords used to define a function.
    ["@keyword.import"]             = { fg = c.magenta2 },
    ...
    ["@markup.list"]                = { fg = c.blue0 }, -- For special punctutation that does not fall in the categories before.
    ...
    ["@module"]                     = "Directory",
    ["@module.builtin"]             = { fg = c.teal }, -- Variable names that are defined by the languages, like `this` or `self`.
    ["@namespace.builtin"]          = "@variable.builtin",
    ["@none"]                       = {},
    ["@number"]                     = "Number",
    ["@number.float"]               = "Float",
    ["@operator"]                   = { fg = c.magenta }, -- For any operator: `+`, but also `->` and `*` in C. --purple
    ["@property"]                   = { fg = c.blue5 },
    ["@punctuation.bracket"]        = { fg = c.dark6 }, -- For brackets and parens.
    ["@punctuation.delimiter"]      = { fg = c.dark6 }, -- For delimiters ie: `.`
    ["@punctuation.special"]        = { fg = c.magenta }, -- For special symbols (e.g. `{}` in string interpolation)
    ["@punctuation.special.markdown"] = { fg = c.magenta }, -- For special symbols (e.g. `{}` in string interpolation)
    ["@string"]                     = "String",
    ["@string.documentation"]       = { fg = c.green2 },
    ["@string.escape"]              = { fg = c.magenta }, -- For escape characters within a string.
    ["@string.regexp"]              = { fg = c.green1 }, -- For regexes.
    ["@tag"]                        = "Label",
    ["@tag.attribute"]              = "@property",
    ["@tag.delimiter"]              = "Delimiter",
    ["@tag.delimiter.tsx"]          = { fg = c.blue0 },
    ["@tag.tsx"]                    = { fg = c.red },
    ...
    ["@variable.member"]            = { fg = c.dark7 }, -- For fields.
    ["@variable.parameter"]         = { fg = c.blue6 }, -- For parameters of a function.
