...
function M.get(c, opts)
  ...
  local ret = {
    ...
    SnacksIndentScope          = { fg = c.magenta2, nocombine = true },
    SnacksZenIcon              = { fg = c.purple },
    SnacksInputIcon            = { fg = c.blue1 },
    SnacksInputBorder          = { fg = c.yellow, bg = c.bg_float },
    SnacksInputTitle           = { fg = c.yellow },
    -- Picker
    SnacksPicker               = "Normal",
    SnacksPickerPreview        = "NormalFloat",
    SnacksPickerBorder         = { fg = c.orange1, bg = c.bg },
    SnacksPickerInputBorder    = { fg = c.orange1, bg = c.bg },
    SnacksPickerInputTitle     = { fg = c.orange1, bg = c.bg },
    SnacksPickerBoxTitle       = { fg = c.orange1, bg = c.bg },
